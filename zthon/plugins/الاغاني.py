...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الاسـتخـدام": "{tr}اغنيه + اسـم الاغنيـه",
        "مثــال": "{tr}اغنيه حسين الجسمي احبك",
    },
)
...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الاسـتخـدام": "{tr}بحث <اسم الاغنيـه>",
        "مثــال": "{tr}بحث محمد السالم وهيلي لوف",
    },
)
