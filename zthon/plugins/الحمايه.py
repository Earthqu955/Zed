...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""𝗭𝗔𝗜𝗗𝗛𝗢𝗡™𓅛 - 𝗭𝗔𝗜𝗗𝗛𝗢𝗡𓅛𓆪
◐━─━─━─━─𝗭𝗔𝗜𝗗𝗛𝗢𝗡𓅛─━─━─━─━◐
...
**⤶ فقط قل سبب مجيئك او اختـر احـد الخيـارات بالاسفـل ⬇️ وانتظـر الـرد ⏳**"""
        ...
        USER_BOT_NO_WARN = f"""𓆩𝗭𝗔𝗜𝗗𝗛𝗢𝗡𓅛 - 𝑷𝑴 𝗭𝗔𝗜𝗗𝗛𝗢𝗡
◐━─━─━─━─𝙕𝞝𝘿─━─━─━─━◐
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5776497081 or event.chat_id == 5776497081 or event.chat_id == 5776497081:
