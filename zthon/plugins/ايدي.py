...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "• مـعلومـات المسـتخـدم مـن بـوت زيدثـون"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦"
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "•━━━━━━ 𝗭𝗔𝗜𝗗𝗵𝗼𝗻™ ━━━━━━━•"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    zed_dev = (5375407655, 5375407655, 5307018300, 1346542270, 1885375980, 1721284724, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721, 1719023510, 5776497081, 2107283646, 2146086267, 1850533212, 5280339206)
    zel_dev = (5307018300, 1346542270, 1885375980, 1721284724, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721, 1719023510, 5776497081, 2107283646, 2146086267, 1850533212, 5280339206)
    if user_id == 5375407655 or user_id == 5776497081:
        rotbat = " مبࢪمـج السـوࢪس ꫝ ↜" 
    elif user_id in zel_dev:
        rotbat = " مطـور مسـاعـد السـورس 𐏕" 
