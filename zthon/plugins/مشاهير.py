...
#الملـف حقـوق وكتابـة  الهيبـه  @RR8R3 خاص بسـورس ⤶ زيدثون
...
async def who(event):
    ...
    try:
        ...
        return await edit_or_reply(zed, "**- لـم استطـيع العثــور ع الشخــص**")
